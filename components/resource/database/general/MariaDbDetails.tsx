import { UpdateMariaDBDatabaseBody } from "@/api/types/database.types";
...
export function MariaDBConfiguration({
  control,
}: {
  control: Control<UpdateMariaDBDatabaseBody>;
}) {
  return (
...
export default function MariaDbDetails({
  control,
  errors,
}: {
  control: Control<UpdateMariaDBDatabaseBody>;
  errors: FieldErrors<UpdateMariaDBDatabaseBody>;
}) {
  const description =
  ...
  return (
    <>
      <View className="flex-1 gap-1">
        ...
        />
        {errors.mariadb_root_password && (
          <Text className="text-red-500">
            {errors.mariadb_root_password.message}
          </Text>
        )}
      </View>
      <View className="flex-1 gap-1">
        ...
        />
        {errors.mariadb_user && (
          <Text className="text-red-500">{errors.mariadb_user.message}</Text>
        )}
      </View>
      ...
      <View className="flex-1 gap-1">
        ...
        />
        {errors.mariadb_password && (
          <Text className="text-red-500">
            {errors.mariadb_password.message}
          </Text>
        )}
      </View>

  ...
  return (
    <View className="gap-2">
      ...
      <View className="flex-row items-center gap-4">
          ...
          description={
            <View className="gap-2">
              <Text className="text-muted-foreground">
                Labels are readonly by default. Readonly means that edits you do
                to the labels could be lost and Coolify will autogenerate the
                labels for you. If you want to edit the labels directly, disable
                this option.
              </Text>
              <Text className="text-muted-foreground">
        ...
        />
        <Checkbox
          checked={readonlyLabels}
          onCheckedChange={setReadonlyLabels}
        />
      </View>
